...
This suggests that earnings are related to rental prices, but a substantial amount of variation is associated with other factors.
...
The highest rent-pressure values were:
...
Household income, taxes, benefits, savings and living expenses are not included.
...
The rental and earnings datasets are based on observed/sample data rather than every worker or rental property.
Sample sizes differ between boroughs. One-bedroom rental counts range from approximately 150 to 890 observations.
Missing or unavailable observations may affect the representativeness of borough-level estimates.
Some ONS estimates may be suppressed when the available sample is too small or statistically unreliable.
The City of London was excluded from earnings-based calculations because its median earnings estimate was suppressed.

The residuals should therefore be interpreted as showing where rents are unusually high or low relative to the London-wide earnings-rent relationship, not as definitive measures of affordability.

Repository structure
london-rent-vs-earnings/
│
├── london_rent_vs_earnings.ipynb
├── london_rent_vs_earnings_final_results.csv
├── README.md
└── data/
    └── london_rent_earnings_2025_merged.csv
Tools
Python
pandas
scikit-learn
